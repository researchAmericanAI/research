...
/polarity → 0: when you have it in 0 mode, it will try to answer with the full 55 problem-solving toolsw; 1: when you have it in 1 mode, it will try to answer with yes, no, or give a direct answer
